...
public class JavaParser extends Parser {
	...
	public static final int
		...
		ELLIPSIS=124, BLOCK_COMMENT=125, LINE_COMMENT=126, WS=127, MWS=128, TAB=129, 
		NEWLINE=130, IDENTIFIER=131;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"URSHIFT_ASSIGN", "ARROW", "COLONCOLON", "AT", "ELLIPSIS", "BLOCK_COMMENT", 
			"LINE_COMMENT", "WS", "MWS", "TAB", "NEWLINE", "IDENTIFIER"
		};
	}
	...
	public final ArrayInitializerContext arrayInitializer() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & -1958089950478040L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 576461783330553851L) != 0) || _la==IDENTIFIER) {
				{
				setState(657);
				variableInitializer();
				setState(662);
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case 11:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & -1958089950478040L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 576461783330488315L) != 0) || _la==IDENTIFIER) {
					{
					setState(1157);
					expression(0);
					}
	...
	public final ForControlContext forControl() throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & -1958089950215896L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 576461783330488315L) != 0) || _la==IDENTIFIER) {
					{
					setState(1275);
					forInit();
					}
